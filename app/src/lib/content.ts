...
> = {
  "lesson-guide": {
    ...
    intro:
      "피아노 과외를 처음 알아보는 분들이 가장 많이 묻는 질문들입니다. 비용, 선생님 선택, 학원과의 비교, 시간과 횟수까지. 레슨을 하는 사람이 솔직하게 정리했습니다.",
  },
  practice: {
    metaDescription:
  ...
  exam: {
    metaDescription:
      "피아노 음대 입시 준비 시기와 로드맵, 콩쿠르 첫 도전, 입시곡 선택, 무대 떨림 극복, 이화여대 피아노과 입시 현실까지. 재학생이 전하는 입시 정보.",
    intro:
      "입시와 콩쿠르는 정보의 절반이 전략입니다. 준비 시기, 곡 선택, 무대 연습법, 이화여대 피아노과 입시의 현실까지. 최근에 그 길을 지나온 재학생이 정리합니다.",
  },
  repertoire: {
    metaDescription:
      "피아노 초보 추천곡부터 성인 취미 쉬운 곡, 체르니 이후 중급 곡, 뉴에이지, 콩쿠르 레퍼토리까지. 수준별·상황별 피아노 곡 추천 모음.",
    intro:
      "다음에 뭘 칠지 고르는 것도 실력입니다. 입문 3개월 로드맵부터 성인 취미 7곡, 체르니 졸업 이후, 감성 뉴에이지, 콩쿠르 곡 선택까지 수준별로 골랐습니다.",
  },
  parents: {
    metaDescription:
      "아이 피아노 시작 나이, 연습 싫어하는 아이 대응법, 첫 피아노 구입, 방문 레슨 준비, 부모의 역할까지. 피아노 학부모가 꼭 알아야 할 안내.",
    intro:
      "아이의 피아노에서 부모의 역할은 감독이 아니라 환경 설계자입니다. 시작 시기, 연습 전쟁 종식법, 악기 구입, 방문 레슨 준비까지 학부모의 질문에 답합니다.",
  },
  local: {
    metaDescription:
      "서울 피아노 과외 안내. 서대문구·마포구 방문 레슨과 서울 전역 온라인 수업, 이대 앞 이화여대 피아노과 재학생의 1:1 레슨을 지역별로 소개합니다.",
    intro:
      "이화여대 피아노과 재학생의 1:1 레슨은 서울 서대문구·마포구 방문을 중심으로, 서울 전역은 온라인으로 진행합니다. 동네별로 가능한 방식을 정리했습니다.",
  },
};
